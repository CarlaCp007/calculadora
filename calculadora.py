...
#Creación clase para calculadora
class Interfaz:
    ...
    def __init__(self, ventana):
        ...
        self.ventana.configure (background="#84a59e")

        #Agregar una caja de texto para que sea la pantalla de la calculadora
        self.pantalla=Text(ventana, state="disabled",bd=10,insertwidth=5, width=33, height=2, background="#f5cac2", foreground="black", font=("Calibri",15))
        ...
        boton4=self.crearBoton(u"C",escribir=False)
        ...
        boton17=self.crearBoton("=",escribir=False,ancho=20,alto=1)
    ...
    def crearBoton(self, valor, escribir=True, ancho=6, alto=1):
        return Button(self.ventana, text=valor, width=ancho, height=alto,background="#f7ede3", font=("Helvetica",15), command=lambda:self.click(valor,escribir))
